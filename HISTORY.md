...
### 0.4.0 (**master**, not out yet!)
- [B] `spring` helper's format has changed from `spring(10, [120, 12])` to `spring(10, {stiffness: 120, damping: 12})`, in order to accommodate some cool new features in this release and in the future.
...
- [F] TODO link all the fixed bugs
- [I] TODO spring precision
- [I] TODO type friendliness
