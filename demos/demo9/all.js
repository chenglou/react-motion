...
/***/ function(module, exports, __webpack_require__) {
	...
	var _performanceNow = __webpack_require__(62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapTree = __webpack_require__(59);
	...
	var _compareTrees = __webpack_require__(89);
	...
	var _animationLoop = __webpack_require__(88);

	var _animationLoop2 = _interopRequireDefault(_animationLoop);

	var _zero = __webpack_require__(60);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stepper = __webpack_require__(93);
	...
	var Demo = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        _Modal2['default'],
	        { shown: this.state.modalShown, onClose: this.closeModal },
	        'React Motion Rocks!'
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcSpring = __webpack_require__(87);
	...
	var Modal = (function () {
	  ...
	  Modal.prototype.renderModal = function renderModal(anim) {
	    var _props = this.props;
	    ...
	    return _react2['default'].createElement(
	      'div',
	      { className: 'full-screen-overlay', onClick: onClose, style: { opacity: anim.opacity.val } },
	      _react2['default'].createElement(
	        'div',
	        { className: 'modal', style: { transform: 'scale(' + anim.scale.val + ')' } },
	        _react2['default'].createElement(
	          'button',
	  ...
	  Modal.prototype.getEndValue = function getEndValue() {
	  ...
	  Modal.prototype.willEnter = function willEnter() {
	    return {
	      scale: { val: 0.75 },
	      opacity: { val: 0.5 }
	    };
	  ...
	  Modal.prototype.willLeave = function willLeave() {
	    return {
