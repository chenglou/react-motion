...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactCodemirror = __webpack_require__(33);
	...
	var _srcLog = __webpack_require__(30);

	var _srcLog2 = _interopRequireDefault(_srcLog);
	...
	var TransitionSpring = _require.TransitionSpring;
	...
	var Example = React.createClass({
	  ...
	  evalCode: function evalCode() {
	    ...
	    var mountNode = React.findDOMNode(this.refs.mountNode);
	    if (code === '') {
	    ...
	    try {
	      (function () {
	        var jsCode = babel.transform(code).code;
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('div', { ref: 'mountNode' })
	      )
	    );
	  }
	});
	...
	var Demo = React.createClass({
	  ...
	  evalCode: function evalCode() {
	    var headerText = React.findDOMNode(this.refs.headerText);
	    var headerCode = this.state.headerCode;
	    ...
	    try {
	      (function () {
	        var jsCode = babel.transform(headerCode).code;
	        (function doIt(Demo, Example) {
	          eval(jsCode);
	        })();
	      })();
	  ...
	  render: function render() {
	    ...
	    var headerCode = _state.headerCode;
	    var example1 = _state.example1;
	    var example2 = _state.example2;
	    var example3 = _state.example3;
	    var example4 = _state.example4;
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('div', { ref: 'headerText', style: {
	            display: 'flex',
	            justifyContent: 'center',
	            fontWeight: 400,
	            fontSize: '64px'
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(Example, { code: example1 })
	            )
	          ),
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              ...
	              React.createElement(Example, { code: example2 })
	            )
	          ),
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              ...
	              React.createElement(Example, { code: example3 })
	            )
	          ),
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              ...
	              React.createElement(Example, { code: example4 })
	            )
	          )
	        )
	      )
